...
public class DriftDetectionWorkflowTest extends BaseE2ETest {
    ...
    void shouldCompleteFullDriftDetectionWorkflow() {
        ...
        boolean driftEventExists = driftEventsResponse.jsonPath().getList("items.instanceId").contains(instanceId);
    ...
    void shouldCreateDriftEventsWhenConfigDriftIsDetected() {
        ...
        boolean driftEventInList = driftEventsResponse.jsonPath().getList("items.id").contains(createdDriftEventId);
        ...
        logTestResult("Drift Event Creation", "Drift events created successfully when config drift is detected");
    }
