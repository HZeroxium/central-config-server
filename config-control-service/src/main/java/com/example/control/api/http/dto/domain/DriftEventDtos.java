...
public final class DriftEventDtos {
    ...
    public static class UpdateRequest {
        @Schema(description = "New drift status", example = "RESOLVED", allowableValues = {"DETECTED", "RESOLVED",
                "IGNORED"})
        private DriftEvent.DriftStatus status;
    ...
    public static class QueryFilter {
        ...
        @Schema(description = "Filter by drift status", example = "DETECTED", allowableValues = {"DETECTED", "RESOLVED",
                "IGNORED"})
        private DriftEvent.DriftStatus status;

        @Schema(description = "Filter by severity level", example = "HIGH", allowableValues = {"LOW", "MEDIUM", "HIGH",
                "CRITICAL"})
        private DriftEvent.DriftSeverity severity;
