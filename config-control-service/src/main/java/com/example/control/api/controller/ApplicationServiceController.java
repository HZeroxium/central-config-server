...
public class ApplicationServiceController {
    ...
    @Operation(summary = "List all application services", description = """
            ...
            **Access Control:**
            ...
            """, security = @SecurityRequirement(name = "oauth2_auth_code"), operationId = "findAllApplicationServices")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved application services", content = @Content(schema = @Schema(implementation = Page.class))),
    ...
    public ResponseEntity<Page<ApplicationServiceDtos.Response>> findAll(
            @Parameter(description = "Optional query filter for searching services", schema = @Schema(implementation = ApplicationServiceDtos.QueryFilter.class)) @RequestParam(required = false) ApplicationServiceDtos.QueryFilter filter,
        ...
        Page<ApplicationServiceDtos.Response> responses = page.map(ApplicationServiceApiMapper::toResponse);
    ...
    @Operation(summary = "Create a new application service", description = """
            ...
            **Required Permissions:**
            ...
            """, security = @SecurityRequirement(name = "oauth2_auth_code"), operationId = "createApplicationService")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get application service by ID", description = """
            ...
            **Access Control:**
            ...
            """, security = @SecurityRequirement(name = "oauth2_auth_code"), operationId = "findApplicationServiceById")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update application service", description = """
            ...
            **Required Permissions:**
            ...
            """, security = @SecurityRequirement(name = "oauth2_auth_code"), operationId = "updateApplicationService")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete application service", description = """
            ...
            **Required Permissions:**
            ...
            """, security = @SecurityRequirement(name = "oauth2_auth_code"), operationId = "deleteApplicationService")
    @ApiResponses(value = {
