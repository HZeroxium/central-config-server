...
import com.example.control.api.http.mapper.infra.ConsulMapper;
...
public class ServiceRegistryController {
        ...
        @GetMapping("/services")
        @Operation(summary = "List all registered services", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved service list", content = @Content(schema = @Schema(implementation = ConsulDto.ConsulServicesMap.class))),
        ...
        // ConsulDto.ConsulServiceResponse.class, type = "array"))),
        ...
        // content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        // @ApiResponse(responseCode = "500", description = "Internal server error or
        // Consul unreachable",
        // content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        // })
        // @Timed(value = "api.registry.services.get")
        // public ResponseEntity<List<ConsulDto.ConsulServiceResponse>>
        ...
        // List<ConsulDto.ConsulServiceResponse> serviceDetails =
        // ConsulMapper.parseServiceResponse(response, objectMapper);

        // return ResponseEntity.ok(serviceDetails);
        // }

        @GetMapping("/services/{serviceName}/instances")
        @Operation(summary = "Get service instances", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Service instances retrieved successfully", content = @Content(schema = @Schema(implementation = ApiResponseDto.ServiceInstancesRegistryResponse.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Authentication required", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        ...
        public ResponseEntity<ApiResponseDto.ServiceInstancesRegistryResponse> getServiceRegistryServiceInstances(
                ...
                List<ApiResponseDto.ServiceInstanceSummary> summaries = ConsulMapper.toSummariesFromHealthJson(response,
                                objectMapper);
                ApiResponseDto.ServiceInstancesRegistryResponse responseDto = ApiResponseDto.ServiceInstancesRegistryResponse
                                .builder()
        ...
        // content = @Content(schema = @Schema(implementation =
        // ConsulDto.ConsulHealthResponse.class, type = "array"))),
        // @ApiResponse(responseCode = "401", description = "Unauthorized -
        // Authentication required",
        // content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        // @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient
        ...
        // List<ConsulDto.ConsulHealthResponse> healthStatus =
        // ConsulMapper.parseHealthResponse(response, objectMapper);
