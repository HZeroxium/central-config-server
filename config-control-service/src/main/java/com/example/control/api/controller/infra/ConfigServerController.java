...
import com.example.control.application.external.ConfigServerClient;
...
public class ConfigServerController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved configuration environment", content = @Content(schema = @Schema(implementation = ConfigServerDto.ConfigEnvironmentResponse.class))),
                        @ApiResponse(responseCode = "400", description = "Invalid application or profile name", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        ...
        public ResponseEntity<ConfigServerDto.ConfigEnvironmentResponse> getEnvironment(
                        ...
                        @Parameter(description = "Optional Git label/branch for configuration version", example = "main") @RequestParam(required = false) String label) {

                log.debug("Getting environment for application: {}, profile: {}, label: {}", application, profile,
                                label);
        ...
        @GetMapping("/health")
        @Operation(summary = "Get Config Server health status", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Config Server health status retrieved successfully", content = @Content(schema = @Schema(implementation = ConfigServerDto.ActuatorHealthResponse.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Authentication required", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "500", description = "Internal server error or Config Server unreachable", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
        ...
        @Operation(summary = "Proxy to Config Server actuator endpoint", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Actuator endpoint response retrieved successfully", content = @Content(schema = @Schema(implementation = Object.class))),
                        @ApiResponse(responseCode = "400", description = "Invalid actuator path", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Authentication required", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        ...
        @GetMapping("/info")
        @Operation(summary = "Get Config Server information", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Config Server information retrieved successfully", content = @Content(schema = @Schema(implementation = ConfigServerDto.ConfigServerInfo.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Authentication required", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
