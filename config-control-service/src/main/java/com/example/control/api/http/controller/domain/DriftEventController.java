...
import com.example.control.api.http.mapper.domain.DriftEventApiMapper;
...
public class DriftEventController {
        ...
        @PostMapping
        @Operation(summary = "Create drift event", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Drift event created successfully", content = @Content(schema = @Schema(implementation = DriftEventDtos.Response.class))),
        ...
        public ResponseEntity<DriftEventDtos.Response> create(
                        @Parameter(description = "Drift event creation request", schema = @Schema(implementation = DriftEventDtos.CreateRequest.class)) @Valid @RequestBody DriftEventDtos.CreateRequest request,
        ...
        @GetMapping("/{id}")
        @Operation(summary = "Get drift event by ID", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Drift event found", content = @Content(schema = @Schema(implementation = DriftEventDtos.Response.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Authentication required", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Drift event not found", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
        public ResponseEntity<DriftEventDtos.Response> findById(
                        @Parameter(description = "Drift event ID", example = "drift-12345") @PathVariable String id,
                        @AuthenticationPrincipal Jwt jwt) {
                UserContext userContext = UserContext.fromJwt(jwt);
        ...
        @PatchMapping("/{id}")
        @Operation(summary = "Update drift event", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Drift event updated successfully", content = @Content(schema = @Schema(implementation = DriftEventDtos.Response.class))),
                        @ApiResponse(responseCode = "400", description = "Invalid request data", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Authentication required", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Drift event not found", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        ...
        public ResponseEntity<DriftEventDtos.Response> update(
                        @Parameter(description = "Drift event ID", example = "drift-12345") @PathVariable String id,
                        @Parameter(description = "Drift event update request", schema = @Schema(implementation = DriftEventDtos.UpdateRequest.class)) @Valid @RequestBody DriftEventDtos.UpdateRequest request,
                        @AuthenticationPrincipal Jwt jwt) {
                UserContext userContext = UserContext.fromJwt(jwt);
        ...
        @GetMapping
        @Operation(summary = "List drift events with filters and pagination", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Drift events retrieved successfully", content = @Content(schema = @Schema(implementation = DriftEventDtos.DriftEventPageResponse.class))),
