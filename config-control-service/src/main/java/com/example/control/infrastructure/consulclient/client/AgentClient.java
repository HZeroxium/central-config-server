...
import com.example.control.infrastructure.consulclient.model.Service;
 ...
 *
 * <p>
 * This interface provides access to the Consul Agent API, which manages
 * the local Consul agent. The agent is responsible for registering services,
 * performing health checks, and coordinating with other agents in the cluster.
 * </p>
 *
 * <p>
 * All methods return {@link ConsulResponse} objects that contain both the
 * response data and Consul metadata (index, leader status, etc.).
 * </p>
 *
