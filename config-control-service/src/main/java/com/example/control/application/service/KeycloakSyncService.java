...
//                     String errorMsg = String.format("Failed to sync user %s: %s", username, e.getMessage());
...
//                     String errorMsg = String.format("Failed to sync team %s: %s", name, e.getMessage());
//                     errorMessages.add(errorMsg);
//                     log.error(errorMsg, e);
//                 }
//             }
...
//         String accessToken = tokenResponse != null ? getString(tokenResponse, "access_token") : null;
...
//     private static List<String> getStringList(Map<String, Object> src, String key) {
//         Object v = src.get(key);
