 ...
 * <p>
 * Handles cascading updates to related entities when service ownership is
 * transferred.
...
public class ServiceOwnershipEventListener {
         ...
         * Evicts all cache entries for service-instances and drift-events related to
         * the service
         * since bulk update affects multiple instances.
         *
        ...
        public void handleServiceOwnershipTransferred(ServiceOwnershipTransferred event) {
                ...
                try {
                        ...
                        // Note: We don't rethrow the exception to avoid rolling back the main
                        // transaction
                        // The event processing failure should be handled separately (e.g., retry
                        // mechanism)
                }
        }
}
