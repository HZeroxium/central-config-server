...
public class ServiceInstanceService {
    ...
    public List<ServiceInstance> findAllWithDrift() {
        ServiceInstanceCriteria criteria = ServiceInstanceCriteria.withDrift();
        return queryService.findAll(criteria, Pageable.unpaged()).getContent();
    }
    ...
    public List<ServiceInstance> findByServiceWithDrift(String serviceId) {
        ServiceInstanceCriteria criteria = ServiceInstanceCriteria.forServiceWithDrift(serviceId);
        return queryService.findAll(criteria, Pageable.unpaged()).getContent();
    }
