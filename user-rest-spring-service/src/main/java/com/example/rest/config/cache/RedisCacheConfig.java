...
public class RedisCacheConfig {
    ...
    // Note: Let Spring Boot auto-configure RedisConnectionFactory from
    // SPRING_DATA_REDIS_URL or spring.data.redis.*
    ...
    public KeyGenerator keyGenerator() {
        return (target, method, params) -> target.getClass().getSimpleName() + ":" + method.getName() + ":v1:"
