...
public class UnifiedCacheConfig {
  ...
  public CacheManager cacheManager() {
    ...
    CacheManager manager = factory.createCacheManager();

    log.info("Initialized cache manager: {} with provider: {}",
        manager.getClass().getSimpleName(), cacheProperties.getProvider());
  ...
  public CacheHealthIndicator cacheHealthIndicator() {
    return new CacheHealthIndicator(cacheManagerFactory(), cacheProperties);
  }
}
