...
public class PhaseListeners {
     ...
     */
    @KafkaListener(id = "P1", topics = KafkaConstants.TOPIC_USER_UPDATE_PHASE_1_COMMAND, groupId = KafkaConstants.GROUP_USER_UPDATE_WORKERS, containerFactory = KafkaConstants.CONTAINER_FACTORY_TX, concurrency = "3")
     ...
     */
    @KafkaListener(id = "P2", topics = KafkaConstants.TOPIC_USER_UPDATE_PHASE_2_COMMAND, groupId = KafkaConstants.GROUP_USER_UPDATE_WORKERS, containerFactory = KafkaConstants.CONTAINER_FACTORY_TX, concurrency = "3")
     ...
     */
    @KafkaListener(id = "P3", topics = KafkaConstants.TOPIC_USER_UPDATE_PHASE_3_COMMAND, groupId = KafkaConstants.GROUP_USER_UPDATE_WORKERS, containerFactory = KafkaConstants.CONTAINER_FACTORY_TX, concurrency = "3")
     ...
     */
    @KafkaListener(id = "P4", topics = KafkaConstants.TOPIC_USER_UPDATE_PHASE_4_COMMAND, groupId = KafkaConstants.GROUP_USER_UPDATE_WORKERS, containerFactory = KafkaConstants.CONTAINER_FACTORY_TX, concurrency = "3")
    ...
    private void sendPhaseEvent(String topic, PhaseEvent event) {
        try {
            ProducerRecord<String, String> record = new ProducerRecord<>(topic, event.sagaId(),
