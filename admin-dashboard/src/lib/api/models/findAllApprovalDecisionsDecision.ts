...
export type FindAllApprovalDecisionsDecision = typeof FindAllApprovalDecisionsDecision[keyof typeof FindAllApprovalDecisionsDecision];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const FindAllApprovalDecisionsDecision = {
  APPROVE: 'APPROVE',
  REJECT: 'REJECT',
} as const;
