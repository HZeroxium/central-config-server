 ...
 */
import type { KVListResponse } from './kVListResponse';
import type { KVKeysResponse } from './kVKeysResponse';

export type ListKVEntries200 = KVListResponse | KVKeysResponse;
