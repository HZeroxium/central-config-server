 ...
 * Instance status
 */
export type ServiceInstanceResponseStatus = typeof ServiceInstanceResponseStatus[keyof typeof ServiceInstanceResponseStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ServiceInstanceResponseStatus = {
  HEALTHY: 'HEALTHY',
  UNHEALTHY: 'UNHEALTHY',
  DRIFT: 'DRIFT',
  UNKNOWN: 'UNKNOWN',
