 ...
 * Type of grantee
 */
export type ServiceShareResponseGrantToType = typeof ServiceShareResponseGrantToType[keyof typeof ServiceShareResponseGrantToType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ServiceShareResponseGrantToType = {
  TEAM: 'TEAM',
  USER: 'USER',
} as const;
