 ...
 */
import type { AnalyzeConfigRequestFormat } from './analyzeConfigRequestFormat';

/**
 * Request to analyze configuration and provide suggestions
 */
export interface AnalyzeConfigRequest {
  /** Configuration content (YAML, Properties, or INI) */
  configContent: string;
  /** Configuration format */
  format?: AnalyzeConfigRequestFormat;
}
