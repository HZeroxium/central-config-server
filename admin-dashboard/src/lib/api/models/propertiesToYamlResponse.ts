 ...
 */
import type { PropertiesToYamlResponseYamlMap } from './propertiesToYamlResponseYamlMap';

/**
 * Response containing converted YAML content
 */
export interface PropertiesToYamlResponse {
  /** Converted YAML content */
  yamlContent?: string;
  /** YAML as structured map */
  yamlMap?: PropertiesToYamlResponseYamlMap;
