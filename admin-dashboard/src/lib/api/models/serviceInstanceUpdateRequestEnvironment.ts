 ...
 */
export type ServiceInstanceUpdateRequestEnvironment = typeof ServiceInstanceUpdateRequestEnvironment[keyof typeof ServiceInstanceUpdateRequestEnvironment];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ServiceInstanceUpdateRequestEnvironment = {
  dev: 'dev',
  staging: 'staging',
  prod: 'prod',
} as const;
