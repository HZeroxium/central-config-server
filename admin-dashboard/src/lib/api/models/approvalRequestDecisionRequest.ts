 ...
 */
import type { ApprovalRequestDecisionRequestDecision } from './approvalRequestDecisionRequestDecision';

/**
 * Decision data (approve/reject with optional note)
 */
export interface ApprovalRequestDecisionRequest {
  /**
   * Approval decision
   * @minLength 0
   * @maxLength 20
   */
  decision: ApprovalRequestDecisionRequestDecision;
  /**
