 ...
 */
import type { KVObjectResponseData } from './kVObjectResponseData';

/**
 * Structured object stored in KV
 */
export interface KVObjectResponse {
  /** Key-value structure representing the object */
  data?: KVObjectResponseData;
