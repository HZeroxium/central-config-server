 ...
 */
import type { KVTransactionResult } from './kVTransactionResult';

/**
 * Result of KV transaction execution
 */
export interface KVTransactionResponse {
  /** Whether every operation in the transaction succeeded */
  success?: boolean;
  /** Detailed outcome per operation (in request order) */
  results?: KVTransactionResult[];
  /**
   * Error message when transaction fails
   * @nullable
   */
  error?: string | null;
}
