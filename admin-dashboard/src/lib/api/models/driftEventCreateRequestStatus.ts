 ...
 * Drift status
 */
export type DriftEventCreateRequestStatus = typeof DriftEventCreateRequestStatus[keyof typeof DriftEventCreateRequestStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DriftEventCreateRequestStatus = {
  DETECTED: 'DETECTED',
