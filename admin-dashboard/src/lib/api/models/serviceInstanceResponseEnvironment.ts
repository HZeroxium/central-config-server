 ...
 */
export type ServiceInstanceResponseEnvironment = typeof ServiceInstanceResponseEnvironment[keyof typeof ServiceInstanceResponseEnvironment];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ServiceInstanceResponseEnvironment = {
  dev: 'dev',
  staging: 'staging',
  prod: 'prod',
} as const;
