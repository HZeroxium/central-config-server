 ...
 */
export type ServiceInstanceCreateRequestEnvironment = typeof ServiceInstanceCreateRequestEnvironment[keyof typeof ServiceInstanceCreateRequestEnvironment];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ServiceInstanceCreateRequestEnvironment = {
  dev: 'dev',
  staging: 'staging',
  prod: 'prod',
} as const;
