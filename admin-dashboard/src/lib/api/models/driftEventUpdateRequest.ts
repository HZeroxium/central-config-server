 ...
 */
import type { DriftEventUpdateRequestStatus } from './driftEventUpdateRequestStatus';

/**
 * Drift event update request
 */
export interface DriftEventUpdateRequest {
  /** New drift status */
  status?: DriftEventUpdateRequestStatus;
