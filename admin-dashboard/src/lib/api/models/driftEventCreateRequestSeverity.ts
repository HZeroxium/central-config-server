 ...
 */
export type DriftEventCreateRequestSeverity = typeof DriftEventCreateRequestSeverity[keyof typeof DriftEventCreateRequestSeverity];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DriftEventCreateRequestSeverity = {
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  HIGH: 'HIGH',
  CRITICAL: 'CRITICAL',
