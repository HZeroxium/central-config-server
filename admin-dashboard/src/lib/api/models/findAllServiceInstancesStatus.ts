...
export type FindAllServiceInstancesStatus = typeof FindAllServiceInstancesStatus[keyof typeof FindAllServiceInstancesStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const FindAllServiceInstancesStatus = {
  HEALTHY: 'HEALTHY',
  UNHEALTHY: 'UNHEALTHY',
  DRIFT: 'DRIFT',
  UNKNOWN: 'UNKNOWN',
