...
/**
 * Request to generate ZCM SDK configuration
 */
export interface GenerateSdkConfigRequest {
  /** Existing application.yml content */
  applicationYml: string;
  /** Service name (optional, will be extracted from config if not provided) */
  serviceName?: string;
}
