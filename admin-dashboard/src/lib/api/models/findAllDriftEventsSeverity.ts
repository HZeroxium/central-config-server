...
export type FindAllDriftEventsSeverity = typeof FindAllDriftEventsSeverity[keyof typeof FindAllDriftEventsSeverity];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const FindAllDriftEventsSeverity = {
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  HIGH: 'HIGH',
  CRITICAL: 'CRITICAL',
