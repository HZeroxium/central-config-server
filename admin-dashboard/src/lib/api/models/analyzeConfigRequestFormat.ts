 ...
 */
export type AnalyzeConfigRequestFormat = typeof AnalyzeConfigRequestFormat[keyof typeof AnalyzeConfigRequestFormat];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AnalyzeConfigRequestFormat = {
  yaml: 'yaml',
