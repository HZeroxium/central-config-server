 ...
 */
import type { KVObjectWriteRequestData } from './kVObjectWriteRequestData';

/**
 * Object structure to persist
 */
export interface KVObjectWriteRequest {
  /** Object structure to persist */
  data: KVObjectWriteRequestData;
}
