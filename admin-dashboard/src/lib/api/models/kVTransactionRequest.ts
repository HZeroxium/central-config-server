 ...
 */
import type { KVTransactionOperation } from './kVTransactionOperation';

/**
 * Request to execute atomic KV operations
 */
export interface KVTransactionRequest {
  /** Operations to execute atomically */
  operations: KVTransactionOperation[];
}
