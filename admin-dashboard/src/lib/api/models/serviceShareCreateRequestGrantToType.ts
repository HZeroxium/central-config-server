 ...
 * @maxLength 20
 */
export type ServiceShareCreateRequestGrantToType = typeof ServiceShareCreateRequestGrantToType[keyof typeof ServiceShareCreateRequestGrantToType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ServiceShareCreateRequestGrantToType = {
  TEAM: 'TEAM',
  USER: 'USER',
} as const;
