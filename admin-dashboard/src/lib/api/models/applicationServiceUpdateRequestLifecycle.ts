 ...
 * @maxLength 50
 */
export type ApplicationServiceUpdateRequestLifecycle = typeof ApplicationServiceUpdateRequestLifecycle[keyof typeof ApplicationServiceUpdateRequestLifecycle];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApplicationServiceUpdateRequestLifecycle = {
  ACTIVE: 'ACTIVE',
