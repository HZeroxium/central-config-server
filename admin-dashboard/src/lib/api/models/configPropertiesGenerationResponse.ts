 ...
 */
import type { GeneratedClass } from './generatedClass';

/**
 * Response containing generated @ConfigurationProperties classes
 */
export interface ConfigPropertiesGenerationResponse {
  /** List of generated Java classes */
  classes?: GeneratedClass[];
  /** All required import statements */
  imports?: string[];
  /** Spring Boot configuration metadata JSON */
  metadataJson?: string;
  /** Package name used for generation */
  packageName?: string;
}
