...
export type FindAllApplicationServicesEnvironment = typeof FindAllApplicationServicesEnvironment[keyof typeof FindAllApplicationServicesEnvironment];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const FindAllApplicationServicesEnvironment = {
  dev: 'dev',
  staging: 'staging',
  prod: 'prod',
} as const;
