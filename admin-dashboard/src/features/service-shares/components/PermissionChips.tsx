...
const getPermissionColor = (permission: PermissionType): 'default' | 'primary' | 'secondary' | 'error' | 'info' | 'success' | 'warning' => {
  switch (permission) {
    case 'VIEW':
      return 'info';
    case 'EDIT':
...
export const PermissionChips: React.FC<PermissionChipsProps> = ({ permissions }) => {
  return (
