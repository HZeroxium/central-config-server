...
} from '@lib/api/generated/service-registry/service-registry';
...
export default function ServiceRegistryDetailPage() {
  ...
  const { data: instancesData, isLoading, error } =
    useGetServiceRegistryServiceInstances(
      serviceName || '',
      { passing: false },
      {
  ...
  if (!serviceName) {
    return (
      <Alert severity="error">Service name is required</Alert>
    );
  }
  ...
  return (
    <Box>
      ...
      <PageHeader title={`Service: ${serviceName}`} subtitle="Consul service details" />
        ...
        <Stack spacing={3}>
            ...
            <CardContent>
              ...
              <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  ...
                  <Typography variant="body1">{instancesData?.instances?.length || 0}</Typography>
                </Grid>
              </Grid>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              ...
              <Divider sx={{ my: 2 }} />
              {instancesData && instancesData.instances && instancesData.instances.length > 0 ? (
                <Stack spacing={2}>
                      ...
                      <CardContent>
                        <Grid container spacing={2}>
                          <Grid size={{ xs: 12, md: 3 }}>
                            ...
                            <Typography variant="body1">{instance.instanceId}</Typography>
                          </Grid>
                          <Grid size={{ xs: 12, md: 3 }}>
                            <Typography variant="body2" color="text.secondary">
                              Host
