...
/**
 * Canonical snapshot of configuration used for drift detection hashing.
 * Only includes normalized properties sourced from Spring Cloud Config Server.
 */
public final class ConfigSnapshot {
  ...
  /**
   * Create a canonical, stable representation for hashing.
   */
